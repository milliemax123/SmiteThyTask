...
public class taskPanel extends javax.swing.JFrame {
    ...
    */
    ...
    private void addTaskToTable(Task t) {
        taskTableModel.addRow(new Object[]{
            t.getTitle(),
            t.getDueDate(),               // changed date to string date as i was aruging with gui spinners and such for 2 days
            t.getPriority(),
            t.getCategory(),
            t.getStatus()
        });
    ...
    private void initComponents() {
        ...
        burdentable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Title", "Due Date", "Priority", "Category", "Overdue", "Status"
            }
        ));
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                .addComponent(undonebutton, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(editbutton, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(deletebutton, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(markdone, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
    ...
    private void homebuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_homebuttonActionPerformed
        //this takes the user back to the home page
    ...
    private void deletebuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deletebuttonActionPerformed
          int row = burdentable.getSelectedRow();
           ...
           taskList.remove(row);// deletes the task at the selcted row from the arraylistt
           refreshTable();
 ...
 // this takesall the details the user enters into the fields and compiles them at once with the create button
        ...
        if (editingIndex >= 0) {
            ...
            t.setPriority(p);
            t.setCategory(c);
            // this just means to check if its an edit
            editingIndex = -1;
        } else {
            // otherwise it creates a new task object
            t = new Task(nextId++, taskTitle, dueDateText, p, c, s);
            taskList.add(t);
        }

        // this makes a subtask but also gives the option for it to be left blank
        String subText = subtask.getText();
        if (!subText.isEmpty()) {
        ...
        refreshTable();
        showSubtasks(t);
        // clear fields so another task can be added 
        title.setText("");
        subtask.setText("");
        duedate.setText("");
    ...
    public static void main(String args[]) {
         ...
         */
        java.awt.EventQueue.invokeLater(() -> new taskPanel().setVisible(true));
    }
